...
namespace LOIC
{
	...
	{
		const string AttackText = "ЗАРЯД СМЕРТОНОСНОГО ЛАЗЕРА";
		const string StpFldText = "Остановить флудинг-атаку";
		...
		private void frmMain_Load(object sender, EventArgs e)
		{
			...
			this.Text = String.Format("{0} | Когда гарпуны, воздушные стрелялки... и прочие пукалки не работают | v. {1}{2}", Application.ProductName, Application.ProductVersion, unlocked);
		}
        ...
        private void chkMsgRandom_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void chkWaitReply_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void chkAllowGzip_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void chkUseGet_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void lbSepOptions_Click(object sender, EventArgs e)
        {
